...
const PaymentSuccess = ({ticket}) => {
  ...
  return (
    ...
    <div className="payment-success-container" onClick={handleClose}>
      ...
      <p className="success-message">Thank you for your payment. Your transaction has been completed.</p>
        <p>Click on this QR to download</p>
        <img src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${date}/ ${ticket.showTiming}/${ticket.seatInfo}/ ${ticket.movieName}/ ${ticket.theatreName}`} alt="" />
