...
const Corousel2 = () => {
   let data1 = [
        { img: photo1, title: "Joker Folie", genres: "Crime", languages: "English" },
        { img: photo2, title: "Devara", genres: "Action", languages: "Hindi , Telugu" },
        { img: photo3, title: "Stree 2 ", genres: "Horror", languages: "Hindi" },
        { img: photo4, title: "Tumbbad", genres: "Horror", languages: "Hindi" },
        { img: photo5, title: "The Buckingham Murders", genres: "Crime", languages: "English, Hindi" },
        { img: photo6, title: "Shukrana", genres: "Drama", languages: "Punjabi" },
        { img: photo7, title: "Veer Zara", genres: "Drama", languages: "Hindi" },
        { img: photo8, title: "Trailer Screening", genres: "Drama", languages: "Multiple" },
        { img: photo9, title: "Khel Khel Me", genres: "Comedy", languages: "Hindi" },
        { img: photo10, title: "Transformers One", genres: "Animation", languages: "English, Hindi" },
        { img: photo11, title: "Binny and family", genres: "Drama", languages: "Hindi" },
        { img: photo12, title: "Taal", genres: "Drama", languages: "Hindi" },
        { img: photo13, title: "MEIYAZHAGAN", genres: "Drama", languages: "Tamil" },
        { img: photo14, title: "Ardaas sarbat de bhale", genres: "Drama", languages: "Punjabi" },
        { img: photo15, title: "Khiskindam kandam", genres: "Drama", languages: "Malayalam" },
        { img: photo16, title: "Inside out 2", genres: "Animation", languages: "English" },
        { img: photo17, title: "Imax Trailer", genres: "Drama", languages: "Multiple" },
        { img: photo18, title: "Dharmveer", genres: "Biography", languages: "Marathi" },
        { img: photo19, title: "Jab we Met", genres: "Romance", languages: "Hindi" },
        { img: photo20, title: "Khel khel me", genres: "Comedy", languages: "Hindi" }
